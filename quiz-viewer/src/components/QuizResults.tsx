  ...
  useEffect(() => {
    const fetchAndCalculateResults = async () => {
      ...
      try {
        ...
        const apiUrl = `${API_BASE_URL}${quizId}/calculate/${sessionId}`;
  ...
  return (
    <div className={styles.quizResults}>
      ...
      <p className={styles.toursonaDescription}>
        You're{" "}
        {breakdown.find((item) => item.type.id === primaryType.id)?.percentage}%{" "}
      ...
      <CollapsiblePanel
        title="View Your Complete Personality Breakdown"
      ...
      <div className={styles.socialLinks}>
        ...
        <a
          ...
          href={`https://www.tiktok.com/sharer/sharer.php?u=${encodeURIComponent(
            window.location.href
          )}`}
          target="_blank"
          rel="noopener noreferrer"
